<%-- 
    Document   : footer
    Created on : Aug 19, 2020, 7:10:01 PM
    Author     : alex
--%>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
                <h2 class="ftco-heading-2">AL<bold>MA</bold></h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Athens, Greece</span></li>
	                <li><span class="icon icon-phone"></span><span class="text">Not available</span></li>
	                <li><span class="icon icon-envelope"></span><span class="text">Alma.support@gmail.com</span></li>
	              </ul>
	            </div>
            </div>
          </div>
