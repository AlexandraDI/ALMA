                ...
                <div class="app-header__menu">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="/showSellers" class="mm-active">
                                    <i class="metismenu-icon icon-person"></i>
                                    All Sellers
                                </a>
                            </li>
...
<!--                                                            <td class="text-center"><input type="checkbox" id="approved" name="approved" value="1"></td>-->
                                                             <td class="text-center">
                                                                 <a href="/getSellerInfoAdmin?id=${item.userId}" target="_blank"
...
<!--                                                    <center><h4> No Users available</h4></center>-->
                                                         ...
                                                         <tr>
                                                            <td class="text-center"></td>
                                                             <td class="text-center"></td>
                                                            <td class="text-center"></td>
                                                            <td class="text-center">No Sellers Yet</td>
                                                            <td class="text-center"></td>
                                                            <td class="text-center"></td>
                                                        </tr>                                                   
